# -*- coding: utf-8 -*-
"""Yet another copy of 02_06_Application_E_Signature.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18JaRBMuMRWFn0oLTljO6DVkZRePkPrUN
...
!git clone https://github.com/Ame-creates-ai/Module3
...
# Read the image.
sig_org = cv2.imread('Module3/MySignature.jpg', cv2.IMREAD_COLOR)

# Display the actual image in the browser.
Image('Module3/MySignature.jpg', width = '400')
